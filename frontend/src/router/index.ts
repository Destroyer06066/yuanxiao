  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '专业配置', roles: ['OP_ADMIN', 'SCHOOL_ADMIN', 'SCHOOL_STAFF'] },
      },
      {
        path: '/quota',
        name: 'QuotaManage',
        component: () => import('@/views/school/QuotaManage.vue'),
        meta: { title: '名额管理', roles: ['OP_ADMIN', 'SCHOOL_ADMIN', 'SCHOOL_STAFF'] },
      },
      {
        path: '/score-lines',
        name: 'ScoreLineConfig',
        component: () => import('@/views/school/ScoreLineConfig.vue'),
        meta: { title: '分数线配置', roles: ['OP_ADMIN', 'SCHOOL_ADMIN', 'SCHOOL_STAFF'] },
      },
      {
        path: '/brochure',
        name: 'SchoolBrochureConfig',
        component: () => import('@/views/school/SchoolBrochureConfig.vue'),
        meta: { title: '招生简章', roles: ['OP_ADMIN', 'SCHOOL_ADMIN', 'SCHOOL_STAFF'] },
      },
      {
        path: '/supplement',
